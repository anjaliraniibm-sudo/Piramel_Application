...
# Suppress all Selenium logs
logging.getLogger('selenium').setLevel(logging.CRITICAL)

# Setup Chrome options to suppress logs
chrome_options = Options()
chrome_options.add_argument("--log-level=3")  # FATAL
chrome_options.add_experimental_option('excludeSwitches', ['enable-logging'])

# Redirect ChromeDriver output to nul (Windows equivalent of /dev/null)
service = Service(
    executable_path="c:/Users/AnjaliRani/Downloads/chromedriver-win64/chromedriver-win64/chromedriver.exe",
    log_path=os.devnull  # This hides the ChromeDriver logs
)
